...
@Component({
  selector: 'app-z-cotizacion-reporte-email-usuario',
  templateUrl: './z-cotizacion-reporte-email-usuario.component.html',
  styleUrls: ['./z-cotizacion-reporte-email-usuario.component.css'],
  providers: [CotizacionRamoGeneral, GlobalesPipe]
})
export class ZCotizacionReporteEmailUsuarioComponent implements OnInit {
